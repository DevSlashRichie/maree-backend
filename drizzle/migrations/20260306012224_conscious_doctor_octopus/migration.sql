...
ALTER TABLE "user_role" ADD CONSTRAINT "user_role_user_id_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id");--> statement-breakpoint
...
ALTER TABLE "user_password" ADD CONSTRAINT "user_password_user_id_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id");