...
export const ProductAllowedIngredientSchema = createSelectSchema(productAllowedIngredientsTable);

export const CreateAllowedIngredientDto = z.object({
...
export type CreateAllowedIngredientDto = z.infer<typeof CreateAllowedIngredientDto>;
