...
userRouter.openapi(
  createRoute({
    ...
    method: "get",
    path: "/",
    middleware: [authzMiddleware(true), checkPolicyMiddleware(["read:users"])],
    request: {
...
userRouter.openapi(
  createRoute({
    ...
    path: "/{userId}/roles",
    security: [{ Bearer: [] }],
    middleware: [authzMiddleware(true), checkPolicyMiddleware(["write:roles"])],
    request: {
      params: z.object({
        userId: z.string().uuid(),
      }),
...
userRouter.openapi(
  createRoute({
    ...
    path: "/staff/{userId}",
    security: [{ Bearer: [] }],
    middleware: [authzMiddleware(true), checkPolicyMiddleware(["write:staff"])],
    request: {
      params: z.object({
        userId: z.string().uuid(),
      }),
